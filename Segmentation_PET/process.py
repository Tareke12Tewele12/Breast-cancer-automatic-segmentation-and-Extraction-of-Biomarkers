...
class Autopet_baseline:
    ...
    def predict(self):
        ...
        cproc = subprocess.run(
            f"nnUNetv2_predict -i {self.nii_path} -o {self.result_path} -d 039 -c 3d_fullres_resenc -tr nnUNetTrainer_AutoPET3_2000_00002LR -f all -chk checkpoint_best.pth --disable_tta",
            shell=True,
            check=True,
        )
        print(cproc)
